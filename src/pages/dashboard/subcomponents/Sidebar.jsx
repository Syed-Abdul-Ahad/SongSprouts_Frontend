...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        <svg width="22" height="22" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M22.6647 23.798V21.5315C22.6647 20.3293 22.1872 19.1763 21.3371 18.3262C20.487 17.4761 19.334 16.9985 18.1318 16.9985H9.06591C7.86369 16.9985 6.71072 17.4761 5.86063 18.3262C5.01054 19.1763 4.53296 20.3293 4.53296 21.5315V23.798" stroke="#FCFCFC" stroke-width="1.69985" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M13.5989 12.4656C16.1023 12.4656 18.1318 10.4361 18.1318 7.9326C18.1318 5.42913 16.1023 3.39966 13.5989 3.39966C11.0954 3.39966 9.06592 5.42913 9.06592 7.9326C9.06592 10.4361 11.0954 12.4656 13.5989 12.4656Z" stroke="#FCFCFC" stroke-width="1.69985" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      ),
      label: 'Profile',
    },
    {
      ...
      icon: (
        <svg width="22" height="22" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.79937 23.798C8.67698 23.798 10.1991 22.2759 10.1991 20.3982C10.1991 18.5206 8.67698 16.9985 6.79937 16.9985C4.92176 16.9985 3.39966 18.5206 3.39966 20.3982C3.39966 22.2759 4.92176 23.798 6.79937 23.798Z" stroke="#FCFCFC" stroke-width="1.69985" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M10.1991 20.3982V5.66613L23.7979 3.39966V18.1317" stroke="#FCFCFC" stroke-width="1.69985" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M20.3982 21.5316C22.2759 21.5316 23.798 20.0095 23.798 18.1319C23.798 16.2543 22.2759 14.7322 20.3982 14.7322C18.5206 14.7322 16.9985 16.2543 16.9985 18.1319C16.9985 20.0095 18.5206 21.5316 20.3982 21.5316Z" stroke="#FCFCFC" stroke-width="1.69985" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      ),
      label: 'Orders',
    },
    ...
    },
    {
      ...
      <svg width="22" height="22" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 12.5C1 9.45001 2.2116 6.52494 4.36827 4.36827C6.52494 2.2116 9.45001 1 12.5 1C15.55 1 18.4751 2.2116 20.6317 4.36827C22.7884 6.52494 24 9.45001 24 12.5V19.8169C24 21.0359 24 21.6425 23.8189 22.1298C23.6749 22.516 23.4495 22.8666 23.1581 23.1581C22.8666 23.4495 22.516 23.6749 22.1298 23.8189C21.6425 24 21.0344 24 19.8169 24H12.5C9.45001 24 6.52494 22.7884 4.36827 20.6317C2.2116 18.4751 1 15.55 1 12.5Z" stroke="white" stroke-width="2"/>
        <path d="M8.1875 11.0625H16.8125M12.5 16.8125H16.8125" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
      ),
      label: 'Chat',
    },
